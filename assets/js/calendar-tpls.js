...
angular.module("template/rcalendar/calendar.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/calendar.html",
    ...
    "            <button type=\"button\" class=\"btn btn-sm btn-link\" ng-click=\"move(-1)\"><i\n" +
    "                    class=\"fas fa-angle-left fa-2x\"  style=\"color:#151515\"></i></button>\n" +
    "        </div>\n" +
    "        <div class=\"calendar-header col-xs-8 m-auto\">{{title}}</div>\n" +
    "        <div class=\"nav-right col-xs-2\">\n" +
    "            <button type=\"button\" class=\"btn btn-sm btn-link\" ng-click=\"move(1)\"><i\n" +
    "                    class=\"fas fa-angle-right fa-2x\" style=\"color:#151515\"></i></button>\n" +
    "        </div>\n" +
    "    </div>\n" +
...
angular.module("template/rcalendar/month.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/month.html",
    "<div>\n" +
    "    <table style=\"border-collapse: separate;border-spacing: 5px;border:none;\" class=\"table table-bordered table-fixed monthview-datetable monthview-datetable\">\n" +
