...
export default dnComponent({
    ...
    fn: function (scope, fCrud, sModal) {
        ...
        scope.openModal = (type, data) => {
            ...
            switch (type) {
                case 0:
                    scope.title = 'Agregar Tipo de Evento';
                    sModal.open('modal-base-form');
                    break;
                case 1:
                    scope.title = 'Actualizar Tipo de Evento';
                    sModal.open('modal-base-form');
                    break;
                case 2:
                    sModal.question('¿Desea eliminar este Tipo de Evento de la lista?', scope.deleteEvent);
                    break;
                case 3:
                    sModal.question('¿Desea restaurar este Tipo de Evento de la lista?', scope.restoreEvent);
                    break;
            }
        };
    ...
    templateUrl: './src/views/home/components/app/maintenance/event_type/event_type.html',
    stylesUrl: './src/views/home/components/app/maintenance/event_type/event_type.css',
    deps: [
        '$scope',
        'fCrud',
        'sModal',
