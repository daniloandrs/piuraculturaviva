...
export default dnComponent({
    ...
    fn: function (scope, fApi, fCrud, filter, sModal, sStorage, location) {
        ...
        scope.gotoSubcategories = (row) => {

            sStorage.set('category',row);

            location.path(`/mantenimientos/categoria/sub`);
    ...
    templateUrl: './src/views/home/components/app/maintenance/category/category.html',
    stylesUrl: './src/views/home/components/app/maintenance/category/category.css',
    deps: [
        '$scope',
        'fApi',
        'fCrud',
