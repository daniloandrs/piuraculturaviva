    ...
    fn: function (sStorage, cSession, location, sModal, $q, http, env, sInterval, fUser) {
        ...
        status_numbers = {
            ...
            401: {
                ...
                method: data => {
                    sModal.warning('Tu sesión ha terminado, al cerrar este mensaje deberás iniciar sesión nuevamente.', () => {
                        sStorage.clear();
        ...
        let AnalizeUrl = data => {
            if (this.isLogged()) {
                let founded;
                if (data) {
                    founded = this.allowed_routes[data];
        ...
        let Run = (() => {
            ...
            if (this.isLogged()) {
                this.allowed_routes['/home'] = {
                    icon: 'fa fa-home',
                    masked: 'Inicio',
                    name: 'Inicio'
                };
                this.allowed_routes['/cuenta'] = {
                    icon: 'fa fa-user-cog',
                    masked: 'Cuenta',
                    name: 'Cuenta'
                };
                this.allowed_routes['/perfil'] = {
                    icon: 'fa fa-user',
                    masked: 'Perfil',
                    name: 'Perfil'
                };
